...
def main():
    ...
    train_y = pd.read_csv(os.path.join("data", "train_clicked.csv"))
    ...
    y = pd.read_csv(os.path.join("data", "{}_clicked.csv".format(test_set)))
    accuracy = (y["clicked"] == y_pred).sum() / len(y) * 100
